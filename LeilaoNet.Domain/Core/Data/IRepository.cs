...
namespace LeilaoNet.Domain.Interfaces.Data
{
    public interface IRepository<TEntity> : IDisposable
    {
        ...
        ValueTask<TEntity> GetFirstAsync(Expression<Func<TEntity, bool>> predicate, CancellationToken cancellationToken = default);
